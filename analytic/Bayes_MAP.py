...
def main(RUNFLAG):
    ...
    # reduce domain
    params.domain_info = (5000.0,100) #50 m sided cells
    ...
    em_obs_prob = pm.Beta("em_obs_prob",1,1,value=0.005) # per-wasp prob of 
    ...
    grid_obs_prob = pm.Beta("grid_obs_prob",1,1,value=0.004) # probability of
